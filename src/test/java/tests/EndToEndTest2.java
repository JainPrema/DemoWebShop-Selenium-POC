...
public class EndToEndTest2 extends BaseTest {
	...
	public void completeOrder(String user, String passwd, boolean expectedSuccess) {
		...
		book.addBooksToCartByIndex(0);
		book.addBooksToCartByIndex(2);

		CartPage cart1 = home.goToCartPage();
		Assert.assertEquals(cart1.getCartItemsCount(), 2);
